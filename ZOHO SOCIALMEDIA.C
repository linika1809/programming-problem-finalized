...
void main()
{
	...
	int queue[5],element,y,r,r1=0,f,b,b1,p1,pr1,gup,p2,pr2,p3,pr3,p4,pr4,p5,pr5,lc,lc1=0,lc2,lc3,lc4,lc5,l1,li1,l2,li2,l3,li3,l4,li4,l5,li5;
	...
	printf("\n----------------------------------------------------------------------");
  //	printf("Create your post(text format only)");
...
//	int r;
	...
	printf("\nYour Followers List");
	//to declare followers list

	clrscr();

	displayfollower(queue);

  /*	printf("\n\nIf you want to UNFOLLOW from the current user(Y/N): ");
	scanf("%c",&h);   */

	printf("\nDo you want to unfollow the first user if yes press the user number otherwise zero: ");
	scanf("%d",&h1);
	if(h1!=0)
	{
...
//			int p1,pr1;
		...
		if(gup==2 && b1!=2)
		{
			...
			printf("\n   Likes: %d\t Unlike: %d",l2,u2);  //hide
			printf("\n   POST 2: Failure is the steping stone for success!! ");
			printf("\n   Likes: %d\t Unlike: %d",li2,ui2);  //balance hide
